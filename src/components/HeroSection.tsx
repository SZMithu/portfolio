    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 flex items-center justify-between overflow-hidden">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* 3D Canvas */}
          <div className="md:w-1/2 h-[500px] md:absolute inset-0 z-0 ms-auto animate-fade-in-up animate-delay-100 flex items-center justify-center" style={{ background: 'transparent' }}>
            <Canvas className="w-full overflow-visible text-center">
